...
public class PanSemillas implements Pan {
    ...
    /**
     * constructor para un pan con semillas
    ...
    /**
     * descripcion del pan con semillas mas su precio
     *
     * @return texto con la cadena completa
     */
    @Override
    public String getDescripcion() {
        return "Usted Eligio -> " + getNombre() + ".....Costo= " + precioPan + "\n";
    }
    ...
    /**
     * Metodo sobreescrito para el ingredienteJamon
     *
